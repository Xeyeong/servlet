...
<link rel="stylesheet"
	href="<c:url value="/"/>css/style.css?<%=new java.util.Date()%>">
<link rel="stylesheet"
...
<body>
	<header>
		<div class="inner">
			...
			<ul id="gnb">
				<li><a href="<c:url value='/'/>list.el">1</a></li>
				<li><a href="<c:url value='/list.te'/>">2</a></li>
				<li><a href="<c:url value='/'/>list.cu">3</a></li>
				<li><a href="<c:url value='/list.hr'/>">4</a></li>
				<li><a href="#">5</a></li>
				<li><a href="#">6</a></li>
			</ul>
